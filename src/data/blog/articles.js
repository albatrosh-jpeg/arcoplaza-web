export const articles = [
...

  {
    ...
    excerpt:
      "Explicamos qué es la potencia contratada, cómo afecta a la factura y cómo detectar si está sobredimensionada.",
...

  {
    ...
    excerpt:
      "Analizamos cómo funcionan las tarifas fijas e indexadas y qué suele ocurrir cuando se observan periodos largos de tiempo.",
...

  {
    ...
    excerpt:
      "Los fallos más habituales que generan sobrecostes energéticos en comunidades de propietarios.",
  ...
  
{
  ...
  excerpt:
    "Analizamos cuánto consume realmente un ventilador durante la noche y cuánto impacto tiene en la factura eléctrica.",
