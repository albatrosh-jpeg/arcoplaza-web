...
const contactItems = [
  {
    label: 'Teléfono',
    value: '+34 692 64 14 39',
    href: 'tel:+34692641439',
    icon: Phone
  },
  {
    label: 'WhatsApp',
    value: 'Abrir conversación',
    href: 'https://wa.me/34692641439',
    icon: MessageCircle,
    external: true
  },
  {
...
export default function Contacto() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-surface-primary px-5 py-10 text-corporate sm:px-8 sm:py-14">
      <Seo
        title="Enrique Plaza | Arcoplaza Asesores"
        description="Datos de contacto de Enrique Plaza, consultor energético en Arcoplaza Asesores."
      ...
      <article className="card-top-accent w-full max-w-[520px] overflow-hidden rounded-[20px] border border-border-soft bg-white px-6 py-8 shadow-[0_24px_70px_rgba(24,55,93,0.10)] sm:px-10 sm:py-10">
        ...
        <div className="mt-3 grid gap-3">
          <a
            href="/enrique-plaza.vcf"
            download="Enrique-Plaza.vcf"
